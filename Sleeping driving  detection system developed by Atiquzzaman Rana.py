...
root.title('Sleeping driving  detection system developed by Atiquzzaman Rana')
frame.config(background='light blue')
label = Label(frame, text="Atiquzzaman Rana",bg='light blue',font=('Times 35 bold'))
label.pack(side=TOP)
filename = PhotoImage(file="rana.png")
...
def Contri():
   tkinter.messagebox.showinfo("Contributors","Rana")
